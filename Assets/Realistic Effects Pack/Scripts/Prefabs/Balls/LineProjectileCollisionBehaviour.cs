...
public class LineProjectileCollisionBehaviour: MonoBehaviour
{
  ...
  private void CollisionEnter()
  {
		if (hit.collider.gameObject.tag == "player")
			hit.collider.gameObject.GetComponent<HealthUIScript> ().takeDamage (1000);
		else if (hit.collider.gameObject.tag == "ennemyBossTribu")
			hit.collider.gameObject.GetComponent<IAScript> ().dgt += 5;
